...
final class ModifyTriggerRecalcularMetaAlActualizarReferencia extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->execute('DROP TRIGGER IF EXISTS `recalcular_meta_al_actualizar_referencia`');
        $sql = '
