---
title: Diagramas de flujo tablero
---

En este diagrama se puede ver el flujo con el cual se construyen las graficas que se encargan se listar cada empleado y su eficiencia, tanto del día, como de la quincena.
